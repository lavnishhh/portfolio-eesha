...
export default function Extracurricular() {
    ...
    },
    {
      ...
      "event": "HealthXcel Club",
      "image": "healthxcel.jpg"
    },
    {
      "title": "Emcee",
      "event": "SARGARM - State-Level Intercollegiate Fest",
      "image": "sargam.jpg",
    },
    {
      "title": "Emcee",
      "event": "Women's International Day",
    ...
    },
    {
      ...
      "embed": <div className='hidden md:block'><InstagramEmbed></InstagramEmbed></div>
    },
    {
      "title": "Secretary",
      "event": "Women in Engineering (WIE), IEEE Student Branch",
      "image": "ieee.png"
    },
    {
      "title": "Member",
      "event": "Toastmasters International Club",
...
function ProjectCardComponent(props) {
    ...
    return <div className="mb-2 md:mb-8 block bg-primary-200 max-w-sm border border-gray-200 rounded-lg shadow hover:bg-gray-100 break-inside-avoid">
    {event.image && <img className="rounded-t-lg bg-black w-full hidden md:block" src={`${import.meta.env.BASE_URL}images/${event.image}`}></img>}
    ...
    <p className="pb-3 md:pb-6 font-normal text-gray-700 block px-3 md:px-6">{event.event}</p>
</div>;
}